...
// import { X, CheckCircle, AlertCircle, Info, ChevronUp } from "lucide-react";
// import { updateNotificationAPI, viewNotificationAPI } from "../../services/notificationServices";
...
//                 </p>
//                 <button onClick={() => markAsReadMutation.mutate(notif.id)} className="text-gray-400 hover:text-gray-200">
...
//               </div>
//               <button onClick={() => markAsReadMutation.mutate(notif._id)} className="text-blue-400 text-xs font-semibold hover:underline mt-2">
//                 Mark as Read
//               </button>
//             </div>
//           ))
